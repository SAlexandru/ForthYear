...
public class MainTests {
	...
	public final void testMPathisFile() throws Exception {
		Main.main(new String[] {"12347", "./TestSite", "./TestSite/a"});
	}
