...
/** An abstract class for things an agent can perceive. Since an
    ...
    incorporate the results of multiple sensors. This class
    represents the set Per. */
public abstract class Percept {
   ...
   /** Construct a percept for a state from the point of view of a
      ...
      this default constructor. This design allows for greater
      modularity in the case that different agents have different
      kinds of percepts. */
   ...
   public State getState() {return s_;}
   public Agent getAgent() {return a_;}
