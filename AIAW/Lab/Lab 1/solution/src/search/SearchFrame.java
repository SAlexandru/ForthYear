 ...
 * search algorithms: depth-first, breadth-first, iterated, best-first, and
 * genetic.
 *
...
public class SearchFrame extends JFrame implements Runnable {
	...
	public SearchFrame() {
		...
		try {
			...
			Enumeration<?> Enum = graph.getGraph().keys(); // get city names
	...
	private void jbInit() throws Exception {
		...
		NumGenerationsComboBox.addItem(new Integer(1));
		NumGenerationsComboBox.addItem(new Integer(25));
		NumGenerationsComboBox.addItem(new Integer(50));
		NumGenerationsComboBox.addItem(new Integer(75));
		NumGenerationsComboBox.addItem(new Integer(100));
		NumGenerationsComboBox.addItem(new Integer(200));
		NumGenerationsComboBox.addItem(new Integer(500));
		NumGenerationsComboBox.setSelectedItem(new Integer(100));
		...
		PopulationSizeComboBox.addItem(new Integer(10));
		PopulationSizeComboBox.addItem(new Integer(25));
		PopulationSizeComboBox.addItem(new Integer(50));
		PopulationSizeComboBox.addItem(new Integer(75));
		PopulationSizeComboBox.addItem(new Integer(100));
		PopulationSizeComboBox.addItem(new Integer(200));
		PopulationSizeComboBox.addItem(new Integer(500));
		PopulationSizeComboBox.setSelectedItem(new Integer(100));
	 ...
	 *
	 * @param e
	 *            the ActionEvent for the radio button
	 */
	...
	/**
	 * Sets the search to BREADTH_FIRST when the breadth-first search radio
	 * button is selected.
	 *
	 * @param e
	 *            the ActionEvent for the radio button
	...
	/**
	 * Sets the search to ITERATED when the iterated search radio button is
	 * selected.
	 *
	 * @param e
	 *            the ActionEvent for the radio button
	...
	/**
	 * Sets the search to BEST_FIRST when the best-first search radio button is
	 * selected.
	 *
	 * @param e
	 *            the ActionEvent for the radio button
	...
	/**
	 * Sets the search to GENETIC_SEARCH when the genetic search radio button is
	 * selected.
	 *
	 * @param e
	 *            the ActionEvent for the radio button
	 ...
	 *
	 * @param e
	 *            the ActionEvent for the selection
	 */
	...
	void AboutMenuItem_actionPerformed(ActionEvent e) {
		AboutDialog dlg = new AboutDialog(this, "About Search Application",
				true);
	 ...
	 * information into the the text area of the application window. If debug is
	 * set on, additional trace information will be displayed.
	 */
	public void run() {
		...
		case GENETIC_SEARCH: {
			...
			geneticSearch
					.setGeneticObjectClassName((String) GeneticObjClassComboBox
							.getSelectedItem());
			geneticSearch.setMaxNumPasses(((Integer) NumGenerationsComboBox
					.getSelectedItem()).intValue());
			geneticSearch.setDebugOn(debugOn);
			geneticSearch.setPopulationSize(((Integer) PopulationSizeComboBox
					.getSelectedItem()).intValue());
			try {
				geneticSearch.setFitnessThreshold(Double.valueOf(
						FitnessThresholdTextField.getText().trim())
						.doubleValue());
			} catch (Exception e) {
