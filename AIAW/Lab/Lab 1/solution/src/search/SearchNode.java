...
/**
 * The <code>SearchNode</code> class contains the label or name and the state of
 * a node in a <code>SearchGraph</code>.
 *
...
public class SearchNode extends Object {
	 ...
	 *
	 * @param label
	 *            the String that represents the node name
	 * @param state
	 *            the Object the represents the state of the node
	 */
	 ...
	 *
	 * @param node
	 *            the SearchNode to be linked to
	 */
	 ...
	 *
	 * @param node
	 *            the SearchNode array that contains the nodes to be linked
	 * @param nodes
	 *            the SearchNode[] object that contains
	 */
	 ...
	 *
	 * @return <code>true</code> if the node is a leaf. Otherwise, returns
	 *         <code>false</code>.
	 */
	public boolean leaf() {
		return (links.size() == 0);
	 ...
	 *
	 * @param oper
	 *            the Object that contains the definition of the operation that
	 *            created the state of the node
	 */
	...
	/**
	 * Sets the <code>SearchNode</code> flag that indicates the node has been
	 * expanded.
	 */
	...
	/**
	 * Sets the <code>SearchNode</code> flag that indicates whether the node has
	 * been expanded.
	 *
	 * @param state
	 *            the boolean that indicates whether the node has been expanded
	 *            or not
	 */
	...
	/**
	 * Sets the <code>SearchNode</code> flag that indicates that the node has
	 * been tested.
	 */
	 ...
	 *
	 * @param state
	 *            the boolean that indicates whether the node has been tested or
	 *            not
	 */
	 ...
	 *
	 * @return <code>true</code> if the node has been tested. Otherwise, returns
	 *         <code>false</false>.
	 */
	 ...
	 *
	 * @param the
	 *            JTextArea to be displayed in the trace text area
	 * @param textArea
	 *            the JTextArea object that contains
	 */
	...
	/**
	 * Writes a trace statement, using indentation to indicate depth within the
	 * graph.
	 */
	public void trace() {
	 ...
	 *
	 * @param queue
	 *            the Vector to which the node is added
	 * @param position
	 *            where in the queue the node should be added; 0=front, 1=back,
	 *            2=base position on node cost
	 */
