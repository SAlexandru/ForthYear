...
/**
 * The <code>GeneticSearchObject</code> class is used to represent a member of
 * the population being searched or optimized using a genetic search algorithm.
 *
...
public class GeneticSearchObject extends Object {
	...
	/**
	 * Sets the chromosome for this population member and computes the member's
	 * fitness.
	 *
	 * @param chromosome
	 *            the String that represents the chromosome
	 */
	 ...
	 *
	 * @param rate
	 *            the double value of the crossover rate
	 */
	 ...
	 * fitness values must equal 100. This method is only called once from the
	 * GeneticSearch object's init() method.
	 *
	...
	public Hashtable<String, Double> getOperatorFitness() {
		...
		operatorFitness.put("onePointCrossoverAndMutate", new Double(40));
		operatorFitness.put("onePointCrossover", new Double(30));
		operatorFitness.put("mutate", new Double(30));
	 ...
	 *
	 * @param binCode
	 *            a String of 1s and 0s with MSB being char[0] and LSB being
	 *            char[n-1]
	 *
