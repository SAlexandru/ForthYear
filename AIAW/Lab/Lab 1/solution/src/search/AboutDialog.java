...
/**
 * The <code>AboutDialog</code> class implements the About dialog for the search
 * application.
 *
...
public class AboutDialog extends JDialog {
	private static final long serialVersionUID = 4264314489245754202L;
	...
	/**
	 * Creates an <code>AboutDialog</code> object with the given frame, title,
	 * and modal setting.
	 *
	 * @param frame
	 *            the Frame object for this dialog
	 * @param title
	 *            the String object that contains the title of this dialog
	 * @param modal
	 *            the boolean modal flag setting
	 *
	 */
	 ...
	 *
	 * @param e
	 *            the ActionEvent object generated for the OK button
	 *
	 */
