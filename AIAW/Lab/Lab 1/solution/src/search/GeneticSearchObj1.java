...
/**
 * The <code>GeneticSearchObj1</code> class is a specialization of the
 * <code>GeneticSearchObject</code>.
 *
 * @author Joseph P. Bigus
 * @author Jennifer Bigus
 *
 * @copyright Constructing Intelligent Agents with Java (C) Joseph P. Bigus and
 *            Jennifer Bigus 2001
 *
 */
