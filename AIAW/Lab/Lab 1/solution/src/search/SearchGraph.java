 ...
 * SearchNodes</code>. A <code>SearchGraph</code> is used by the five basic
...
class SearchGraph extends Object {
	 ...
	 *
	 * @param name
	 *            the String that identifies the name of the graph
	 */
	 ...
	 *
	 * @param nodeName
	 *            the String that names a node in the graph
	 ...
	 *
	 * @param node
	 *            the SearchNode to be added to the graph
	 */
	...
	/**
	 * Does a depth-first search on graph, starting the the given initial node
	 * and continuing until the goal state is reached.
	 *
	 * @param initialNode
	 *            the SearchNode at which the search begins
	 * @param goalState
	 *            the Object being searched for in the graph
	 *
	 * @return the <code>SearchNode</code> containing the goal is returned, if
	 *         the goal state is found. Otherwise, <code>null</code> is
	 *         returned.
	 */
	...
	/*
	 * Does a breadth-first search on graph, starting the the given initial node
	 * and continuing until the goal state is reached.
	 * 
	 ...
	 * 
	 * @return the <code>SearchNode</code> containing the goal is returned, if
	 * the goal state is found. Otherwise, <code>null</code> is returned.
	 */
	...
	/**
	 * Does a depth-first search on graph, starting the the given initial node
	 * and continuing until the goal state is reached or the given depth is
	 * reached.
	 *
	 * @param initialNode
	 *            the SearchNode at which the search begins
	 ...
	 *            the Object being searched for in the graph
	 * @param maxDepth
	 *            the maximum depth to be searched
	 *
	 * @return the <code>SearchNode</code> containing the goal is returned, if
	 *         the goal state is found. Otherwise, <code>null</code> is
	 *         returned.
	 ...
	 * searches starting at the given initial node and continuing until the goal
	 * state is reached or an arbitrary depth is reached.
	 *
	 * @param initialNode
	 *            the SearchNode at which the search begins
	 *
