...
public class DataSet extends Object implements Serializable {
  /**
	 * 
	 */
	private static final long serialVersionUID = -2125612452200591232L;
protected String name;
  ...
  public void displayVariables() {
    Enumeration<Variable> enumeration = variableList.elements();

    trace("\n\nVariables:");
    while (enumeration.hasMoreElements()) {
      String values;
      Variable temp = (Variable) enumeration.nextElement();
