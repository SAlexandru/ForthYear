...
public abstract class Variable implements Serializable {
  /**
	 * 
	 */
	private static final long serialVersionUID = -7716689448713286491L;
protected String name;
  ...
  public String getLabels() {
    ...
    Enumeration<String> enumeration = labels.elements();

    while (enumeration.hasMoreElements()) {
      labelList += enumeration.nextElement() + " ";
    }
    return labelList;
  }
  ...
  public int getIndex(String label) {
    ...
    while (enumeration.hasMoreElements()) {
      if (label.equals(enumeration.nextElement())) {
        index = i;
        break;
      }
      i++;
