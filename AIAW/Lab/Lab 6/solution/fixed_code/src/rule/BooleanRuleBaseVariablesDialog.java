...
public class BooleanRuleBaseVariablesDialog extends JDialog implements ListSelectionListener {
  /**
	 * 
	 */
	private static final long serialVersionUID = 7130026857068093192L;
JPanel panel1 = new JPanel();
  ...
  protected void initialize() {
    ...
    Enumeration<?> enumeration = ruleBase.variableList.elements();

    while (enumeration.hasMoreElements()) {
      vars.addElement(enumeration.nextElement());
    }
  ...
  public void valueChanged(ListSelectionEvent e) {
    ...
    Enumeration<?> labels = ruleVar.labels.elements();
