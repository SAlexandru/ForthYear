...
public class MaxInvocationLevelOfAbstraction extends PropertyComputer {

	public MaxInvocationLevelOfAbstraction() {
		super("max invocations level of abstraction", "max invocations level of abstraction", "method", "numeric");
	}
