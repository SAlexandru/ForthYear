...
public class GroupDiscriminationActionLargest extends AbstractVisualizationWithProgressMonitor implements IRunnableWithProgress, IObjectActionDelegate {
	...
	public GroupDiscriminationActionLargest() {
		super("GD-Largest", "Group Discrimination Largest", "class");
	}
	...
	public void run(final IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
		try {
			GroupDiscriminationBuilder b = new GroupDiscriminationBuilder(GroupDiscriminationBuilder.TOP_8_LARGEST); 
