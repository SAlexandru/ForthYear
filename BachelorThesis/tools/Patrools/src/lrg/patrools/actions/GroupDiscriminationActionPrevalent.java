...
import lrg.patrools.visualizations.GroupDiscriminationBuilder;
...
public class GroupDiscriminationActionPrevalent extends AbstractVisualizationWithProgressMonitor implements IRunnableWithProgress, IObjectActionDelegate {
	...
	public void run(IAction action) {
		if (theSelection instanceof IStructuredSelection){
			...
			try {
				...
				view.refresh(wrappedType, this, "Group Discrimination for ");
				page.showView("patrools.view");
	...
	public GroupDiscriminationActionPrevalent() {
		super("GD-Prevalent", "Group Discrimination Prevalent", "class");
	}
	...
	public void run(final IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
		try {
			GroupDiscriminationBuilder b = new GroupDiscriminationBuilder(GroupDiscriminationBuilder.TOP_8_PREVALENT); 
