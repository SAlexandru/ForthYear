...
public class MinInvocationLevelOfAbstraction extends PropertyComputer {

	public MinInvocationLevelOfAbstraction() {
		super("min invocations level of abstraction", "min invocations level of abstraction", "method", "numeric");
	}
