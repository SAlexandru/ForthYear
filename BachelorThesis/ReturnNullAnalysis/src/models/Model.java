...
abstract class Model
	{
	private IJavaElement declaringClass;	//the class where the method/field is declared
	private List<OuterMethodModel> outerMethods=new ArrayList<OuterMethodModel>();	//the methods where this method/variable is tested
	...
	public String toString()
		...
		s.append("DECLARING CLASS: "+declaringClass.getElementName()+"OUTER METHODS: ");
		return s.toString();
		}
