...
public class OuterMethodModel {
	...
	public OuterMethodModel(IMethod outerMethod, int lineNumber,
			int endingLine, InfixExpression.Operator operator,
	...
	public String getCustomName() {
		try {
			String s = outerMethod.getDeclaringType().getElementName() + "::"
					+ outerMethod.getElementName() + " : "
