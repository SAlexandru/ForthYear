...
public class VarTableGui extends AbstractTableGui {
	...
	protected void createColumns() {
		...
		TableViewerColumn declaringClassColumn = new TableViewerColumn(viewer,
				SWT.NONE);
		TableViewerColumn isFieldColumn = new TableViewerColumn(viewer,
				SWT.NONE);
		TableViewerColumn wrappingMethodsColumn = new TableViewerColumn(viewer,
				SWT.NONE);
